...
function GoDaddyLogo({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M12 9V13.67H13.67V12.33H14.67V15H12C10.34 15 9 13.66 9 12H10.33" fill="none" />
...
function MockupCard({ title, children }: { title: string; children: React.ReactNode }) {
  return (
    <div className="rounded-2xl border border-slate-200 bg-white shadow-lg shadow-slate-200/60 overflow-hidden">
      <div className="h-9 bg-slate-50 border-b border-slate-100 flex items-center px-3 gap-2 flex-shrink-0">
...
export default function Home() {
  ...
  const features = [
    ...
    { icon: ScanText,  title: "Auto Column Detection",     desc: "Automatically detect name, vehicle, route, and pricing columns from any spreadsheet.",  color: "bg-pink-50 text-pink-600" },
      ...
      <main>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-4">
                      {[
                        ...
                        <div key={i} className="bg-white rounded-xl p-3 border border-slate-100 shadow-sm">
                          ...
                          <div className="h-4 w-10 bg-slate-200 rounded-md text-xs flex items-center justify-center font-bold text-slate-500" style={{ fontSize: 9 }}>{v}</div>
                        </div>
                      ))}
                    </div>
                      ...
                      {[82, 65, 48, 91].map((w, i) => (
                        <div key={i} className="flex items-center gap-3">
                          ...
                          <div className="flex-1 space-y-1.5 min-w-0">
                            ...
                            <div className="h-1.5 rounded-full bg-blue-100" style={{ width: `${w - 15}%` }} />
                          </div>
          ...
          <div className="container mx-auto max-w-5xl text-center">
            ...
            <div className="flex flex-wrap items-center justify-center gap-4 sm:gap-6">
              {providers.map(({ name, Logo }) => (
                <div
                  key={name}
                  className="flex items-center gap-2.5 px-4 py-2.5 rounded-2xl bg-white border border-slate-200 shadow-sm hover:shadow-md transition-shadow group"
                >
          ...
          <div className="container mx-auto max-w-5xl">
            <div className="text-center mb-14">
              <h2 className="text-3xl sm:text-4xl font-bold text-slate-900 mb-3">
                Everything you need for broker outreach
              </h2>
        ...
        <section className="py-24 px-5 bg-gradient-to-b from-slate-50 to-white border-y border-slate-100">
          <div className="container mx-auto max-w-5xl">
            <div className="text-center mb-14">
              <h2 className="text-3xl sm:text-4xl font-bold text-slate-900 mb-3">
                How BrokerMail AI works
              </h2>
              <p className="text-slate-500 max-w-xl mx-auto text-sm sm:text-base">
                Four simple steps from spreadsheet to delivered outreach.
              </p>
            </div>
        ...
        <section className="py-24 px-5">
          <div className="container mx-auto max-w-6xl">
            <div className="text-center mb-14">
              ...
              <p className="text-slate-500 max-w-xl mx-auto text-sm sm:text-base">
                A complete outreach platform built around how transport brokers work.
              </p>
            </div>
              ...
              <FadeUp delay={0.15}>
                <div className="group">
                  <div className="mb-3 flex items-center gap-2">
                    ...
                    <span className="text-sm font-semibold text-slate-700">SMTP / IMAP Mailbox Setup</span>
                  </div>
                  <MailboxMockup />
                </div>
              </FadeUp>
                ...
                <div className="group">
                  <div className="mb-3 flex items-center gap-2">
                    <div className="h-7 w-7 rounded-lg bg-amber-50 flex items-center justify-center">
                      <PanelLeft className="h-4 w-4 text-amber-600" />
                    </div>
          ...
          <div className="container mx-auto max-w-5xl">
            <div className="text-center mb-14">
              ...
              <p className="text-slate-400 max-w-xl mx-auto text-sm sm:text-base">
                Reliable, private, and fully white-label from day one.
              </p>
            </div>
                ...
                <FadeUp key={i} delay={i * 0.07}>
                  <div className="flex items-start gap-3 bg-slate-800/50 rounded-2xl p-5 border border-slate-700/50 hover:border-slate-600 transition-colors">
                    <div className="h-9 w-9 rounded-xl bg-blue-500/20 flex items-center justify-center flex-shrink-0">
                      <item.icon className="h-4.5 w-4.5 text-blue-400" style={{ height: 18, width: 18 }} />
                    </div>
          ...
          <div className="container mx-auto max-w-5xl">
            <div className="text-center mb-14">
              ...
              <p className="text-slate-500 max-w-lg mx-auto text-sm sm:text-base">
                Plans built for every stage of your brokerage.
              </p>
            </div>
